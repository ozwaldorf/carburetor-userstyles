...
1. Fork the `ozwaldorf/carburetor-userstyles` repository.
...
7. Raise a [pull request](https://github.com/ozwaldorf/carburetor-userstyles/compare), making sure to read and fill out the template properly. The title of your pull request should follow the format of `feat(<name-of-website>): init`.
